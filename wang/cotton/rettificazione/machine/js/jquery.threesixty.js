...
console.log(val)
	...
	$.fn.refresh = ThreeSixty.prototype.refresh = function(){
	        $(this).each(function(i){
            var $this = $(this),
                val = $this.data('lastVal') || 0,
                thisTotal = $this.data('count');
		...
		$.fn.back = ThreeSixty.prototype.back = function(){
	        $(this).each(function(i){
            var $this = $(this),
                val = $this.data('lastVal') || 0,
                thisTotal = $this.data('count');
    ...
    ThreeSixty.prototype.onMove = function(screenX, screenY){
        if(isMouseDown){
			...
			$downElem.find('.threesixty-frame').removeClass("wode");
            $downElem.find('.threesixty-frame:eq(' + val + ')').addClass("wode");
